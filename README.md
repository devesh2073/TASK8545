...
clone the repository using git bash to local
...
### Sync Gradle:
Android Studio will automatically start syncing the Gradle files. If it doesn't, click on 'Sync Now' in the bar that appears at the top of the code editor.

### Run the Application:

After syncing, run the app using an emulator or a physical device.
